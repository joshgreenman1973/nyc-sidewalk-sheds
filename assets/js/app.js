(() => {
  ...
  function openEmbed() {
    // Derive the URL from where this page is actually served rather than hard-coding
    // it. The previous version hard-coded its own address, so after the project moved
    // the embed snippet still pointed at the old, no-longer-updating deployment.
